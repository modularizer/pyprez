...
${this.header}
    ${this.runnable}
            ...
            `}}window.addEventListener("load",()=>{customElements.define("stack-overflow",StackOverflow)});class StackOverflowConverter extends HTMLElement{constructor(){super();let ih=this.innerHTML;let mode=this.hasAttribute("mode")?`mode=${this.getAttribute("mode")}`:"";let src=this.hasAttribute("src")?`src=${this.getAttribute("src")}`:"";let namespace=this.hasAttribute("namespace")?this.getAttribute("namespace"):"global";pyprez.recordNamespaceName(this.namespace);this.innerHTML=`
